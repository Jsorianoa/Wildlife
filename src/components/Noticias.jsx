                    ...
                    <div className="cards">
                        <div className="card-noticias">
                            ...
                            <div className="container">
                                ...
                                <p>Si necesitas monitorear fauna silvestre a través de fototrampeo, nosotros podemos ayudarte a conseguir la mejor trampa-cámara que se ajuste a tus necesidades, tanto de logística como económicas, ya sean fotos tradicionales o panorámicas. Ofrecemos modelos de las principales marcas en el ramo como: 𝗕𝗿𝗼𝘄𝗻𝗶𝗻𝗴, 𝗕𝘂𝘀𝗵𝗻𝗲𝗹𝗹, 𝗖𝘂𝗱𝗱𝗲𝗯𝗮𝗰𝗸, 𝗠𝗼𝘂𝗹𝘁𝗿𝗶𝗲, 𝗦𝘁𝗲𝗮𝗹𝘁𝗵𝗖𝗮𝗺, entre otras.Igualmente te podemos ofrecer otros materiales y equipos para el manejo y monitoreo de fauna silvestre. Acércate a nosotros, contáctanos por redes sociales o a nuestro e-mail de contacto <span style={{fontSize:'19px'}}>(𝗰𝗼𝗻𝘁𝗮𝗰𝘁𝗼@𝘄𝗶𝗹𝗱𝗹𝗶𝗳𝗲𝗺𝗮𝗻𝗮𝗴𝗲𝗺𝗲𝗻𝘁𝗺𝗲𝘅𝗶𝗰𝗼.𝗰𝗼𝗺)</span>. ¹ Envíos a través de las principales paqueterías (𝘋𝘏𝘓, 𝘌𝘴𝘵𝘢𝘧𝘦𝘵𝘢, 𝘍𝘦𝘥𝘌𝘹).² Podemos expedir facturas por las compras.</p>
                            </div>
                        </div>
                        <div className="card-noticias">
